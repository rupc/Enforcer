...
func (h *AuditHandler) handleInit(resp http.ResponseWriter, r AuditServiceRequest) {
	...
	_, err := audit.InitializeAuditor(r.AuditorID, r.CreatorID, r.TargetChainID, r.RecordChainID, r.TxSendAddress, r.Fidelity, r.StateSendAddress, r.FetchMethod, r.MetricFetchAddress, r.ReportAddress, r.FetchAddress, r.MetricNames)
